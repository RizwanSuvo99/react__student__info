...
const Students = () => {
  const studentClassOne = studentInfo.filter(
    (student) => student.class === "Class 1"
  );
  const studentClassTwo = studentInfo.filter(
    (student) => student.class === "Class 2"
  );
  return (
    <section className="py-24 lg:pt-[120px] lg:pb-28 bg-[#172227]">
        ...
        <div className="max-w-[848px] mx-auto overflow-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              {studentClassOne.map((student, index) => (
              ...
              {studentClassTwo.map((student, index) => (
                <Student key={index} student={student} index={index} />
              ))}                              
            </tbody>
          </table>
